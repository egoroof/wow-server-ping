...
Смотрите [Описание процесса пинга](#описание-процесса-пинга) для обяснения разницы между подключением, установлением соединения и пингом.
...
| # | Подключение | Установление соединения | Пинг |
|---|---|---|---|
| 1 | Вы TCP SYN → Прокси | | |
